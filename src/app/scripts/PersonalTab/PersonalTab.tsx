...
import { Provider, Flex, Text, Header, List, Alert, themes, ThemePrepared, WindowMaximizeIcon, ExclamationTriangleIcon, Label, Button, Input, ToDoListIcon } from "@fluentui/react-northstar";
import TeamsBaseComponent, { ITeamsBaseComponentState } from "msteams-react-base-component";
import * as microsoftTeams from "@microsoft/teams-js";
/**
 * State for the PersonalTabTab React component
 */
export interface IPersonalTabState extends ITeamsBaseComponentState {
    entityId?: string;
...
/**
 * Properties for the PersonalTabTab React component
 */
export interface IPersonalTabProps {
 ...
 */
export class PersonalTab extends TeamsBaseComponent<IPersonalTabProps, IPersonalTabState> {
    ...
    public render() {
        return (
            <Provider theme={this.state.teamsTheme}>
                <Flex.Item>
                    <div>
                        <h1>Personal Tab exercise: <a href="https://docs.microsoft.com/en-us/learn/modules/embedded-web-experiences/3-exercise-create-custom-teams-personal-tab">Link</a></h1>
                    </div>
                </Flex.Item>
                <Flex column gap="gap.smaller">
                    ...
                    <Text content="(C) Copyright Neoplus" size="smallest"></Text>
                </Flex>
            </Provider>
