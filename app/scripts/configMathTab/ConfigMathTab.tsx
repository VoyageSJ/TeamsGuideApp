        ...
        return (
            <Provider theme={this.state.teamsTheme}>
                <Header>
                    <Flex.Item></Flex.Item>
                    <div>
                        <h1>channel or group tab exercise: <a href="https://docs.microsoft.com/en-us/learn/modules/embedded-web-experiences/5-exercise-create-custom-teams-channel-tab">Link</a></h1>
                    </div>
                </Header>
